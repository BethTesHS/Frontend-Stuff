    ...
    <div className="space-y-6">
      ...
      <Card className="h-[580px] mr-4 ml-4 flex flex-col bg-white dark:bg-gray-900 border-gray-200 dark:border-gray-800 shadow-sm">
        <CardHeader className="border-b border-gray-200 dark:border-gray-800 pb-4 flex-shrink-0">
          <CardTitle className="text-lg text-gray-900 dark:text-gray-100">Support Chat</CardTitle>
              ...
              <div className="space-y-4">
                {messages.map((message) => (
                  ...
                  >
                    ...
                    <div className={`max-w-xs lg:max-w-md ${message.sender_type === 'user' || message.sender_type === 'tenant' || message.sender_type === 'external_tenant' ? 'text-right' : 'text-left'}`}>
                      <div className={`flex items-center gap-2 mb-1 ${message.sender_type === 'user' || message.sender_type === 'tenant' || message.sender_type === 'external_tenant' ? 'justify-end' : 'justify-start'}`}>
