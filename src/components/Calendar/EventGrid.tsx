...
export const EventGrid = ({ event }: any) => {
  // These stay as status-specific colors (e.g., Pending is always Amber)
  const styles: any = {
    confirmed:
      "bg-emerald-50 text-emerald-700 border-l-emerald-500 dark:bg-emerald-900/30 dark:text-emerald-400 dark:border-l-emerald-400",
    pending:
      "bg-amber-50 text-amber-700 border-l-amber-500 dark:bg-amber-900/30 dark:text-amber-400 dark:border-l-amber-400",
    cancelled:
      "bg-slate-50 text-slate-500 border-l-slate-300 dark:bg-slate-800 dark:text-slate-400 dark:border-l-slate-600",
  };
