...
import { Bell, Eye, MessageSquare, Calendar, AlertTriangle, CheckCircle, Loader2, User } from 'lucide-react';
...
interface TenantNotificationDropdownProps {
  onShowAll: () => void;
  userRole?: string;
}

export const TenantNotificationDropdown = ({ onShowAll, userRole = 'tenant' }: TenantNotificationDropdownProps) => {
